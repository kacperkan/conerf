...
class NerfModel(nn.Module):
    ...
    def query_template(
        ...
        if points.shape[-1] > 3:
            if self.use_attribute_conditioning:
                if self.use_masking:
                    attribute_mask = self.query_template_mask(
                        level,
                        points,
                        viewdirs,
                        metadata,
                    ...
                    if (
                        ...
                        num_attributes = attribute_mask.shape[-1]
                        ...
                        hyper_points = hyper_points.reshape(orig_shape)
                    else:
                        hyper_points = points[..., 3:]
        ...
        if self.use_attribute_conditioning and self.use_masking:
            return rgb, sigma, attribute_mask
        return rgb, sigma
    ...
    def map_hyper_points(
        ...
        return hyper_points, hyper_embed
    ...
    def map_points(
        ...
        return warped_points, warp_jacobian, projected_hyper_embed
    ...
    def render_samples(
        ...
        if self.use_attribute_conditioning and self.use_masking:
            rgb, sigma, attribute_mask = queried_template
        ...
        if (
            ...
            noised_mask = self.query_template_mask(
                level,
                warped_points + noise,
                viewdirs,
                metadata,
        ...
        if render_in_canonical:
            ...
            if self.use_attribute_conditioning and self.use_masking:
                rgb, sigma, attribute_mask = queried_canonical
            else:
