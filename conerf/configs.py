...
class TrainConfig:
    ...
    # NEW: masking gamma schedule
    masking_gamma_schedule: Optional[ScheduleDef] = None
    # The schedule or the hyper sheet position encoding.
    attribute_sheet_alpha_schedule: Optional[ScheduleDef] = None
    viewdir_alpha_schedule: Optional[ScheduleDef] = None
    ...
    # NEW: Whether to use attribute loss to optimize the ambient space
    use_attribute_loss: bool = False
    # NEW: The weight for the attribute loss
    attribute_loss_weight: float = 0.1
    # NEW: The weight for the loss for mask for attributes
    ...
    # NEW: The ratio of samples in a single batch that have to consists of
    # a ground truth.
    samples_with_attribute_ratio: float = 0.25
    # use L2 loss on latent codes
    use_latent_l2_reg: bool = False
    # L2 loss weight on latent codes
    latent_l2_reg_weight: float = 0.0
    # use L2 loss on all parameters
...
class EvalConfig:
    ...
    save_images_to_tensorboard: bool = True
